...
public class StartMenuController extends UIController {
    ...
    private void drawStartMenu(UIHost host) {
        ...
        menuBg.setCornerRadius(32f);
        menuBg.setColor(backgroundTint);
        menuBg.setStroke(3, 0x33FFFFFF);
        startMenuFrame.setBackground(menuBg);
        startMenuFrame.setClipToOutline(true);
        GradientDrawable searchBg = new GradientDrawable();
        searchBg.setShape(GradientDrawable.RECTANGLE);
        searchBg.setCornerRadius(32f);
        searchBg.setColor(backgroundTint);
        searchBg.setStroke(3, 0x33FFFFFF);
        searchViewLayout.setBackground(searchBg);
        searchViewLayout.setClipToOutline(true);
